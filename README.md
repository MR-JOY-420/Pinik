...
name : ```Md Jubaed Ahmed Joy Developer```</br>
age : ```16```</br>
...
original file : [BotPack](https://replit.com/@YanMaglinte/BotPack?v=1) by ```Joy```</br>
modified : [Joy](https://replit.com/@joyahmed) by ```Ryuko Developer```
## UPDATES NEW
• Fixed Login FCA 
• Added some commands
• Missyou
